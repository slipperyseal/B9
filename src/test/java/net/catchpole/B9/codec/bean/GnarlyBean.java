...
//        if (!Almost.equals(that.f1, f1, 1)) return false;
//        if (!Almost.equals(that.d1, d1, 1)) return false;
...
//        if (f2 != null ? !Almost.equals(f2, this.f2, 1) : that.f2 != null) return false;
//        if (d2 != null ? !Almost.equals(d2, this.d2, 1) : that.d2 != null) return false;
